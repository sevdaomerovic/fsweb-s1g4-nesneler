...
function MenuElemaniOlustur(ad, fiyat, sinif) {
  return { isim: ad, fiyat: fiyat, kategori: sinif };
}
...
*/
console.log("Görev 1b.1: ", MenuElemaniOlustur("Cheeseburger", 8, "Burgerler"));
console.log("Görev 1b.2: ", MenuElemaniOlustur("Karışık Pizza", 5, "Pizzalar"));
console.log("Görev 1b.3: ", MenuElemaniOlustur("Latte", 9, "Kahveler"));
...
console.log("Görev 2.öğretmen: ", burger.indirim("öğretmen"));
console.log("Görev 2.öğrenci: ", burger.indirim("öğrenci"));
console.log("Görev 2.diğer: ", burger.indirim("diğer"));
...
function DegerlendirmeEkle(dizi, isim, puan, geribildirim) {
  const yorum = { isim: isim, puan: puan, geribildirim: geribildirim };
  dizi.push(yorum);
  return dizi;
}
console.log(
